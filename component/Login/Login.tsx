            ...
            <div className="space-y-2">
              ...
              <div className="relative rounded-[12px] overflow-hidden transition-all duration-300 focus-within:ring-2 focus-within:ring-[#B89C72]/30">
                ...
                <input
                  ...
                  className="block w-full pl-12 pr-4 py-4 bg-[#FAF7F2] border border-[#EBE5D6] rounded-[12px] text-sm text-[#0B132B] placeholder-gray-400 focus:outline-none focus:border-[#B89C72] focus:bg-[#FAF7F2] transition-colors duration-300 font-sans"
                />
              </div>
            </div>
